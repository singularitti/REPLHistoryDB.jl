...
[discuss with us](https://github.com/singularitti/REPLHistoryDB.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/singularitti/REPLHistoryDB.jl/issues/new) or
[submit a PR](https://github.com/singularitti/REPLHistoryDB.jl/compare) with suggestions.
